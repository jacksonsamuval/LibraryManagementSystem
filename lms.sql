...
('id', 'admin', 'admin@gmail.com', 'admin@1234', 1148458757);
...
(1, 6541, 'Data structure', 'D S Gupta','22TD0517' , 1, '0000-00-00 00:00:00'),
(18, 7845, 'half Girlfriend', 'Chetan Bhagat', '22TD0517', 1, '2020-04-22');
...
(`id`, 'user', 'user@gmail.com', 'user@1234', 2147483644, 'XYZ Coloney, PQR Nagar , Jaipur'),
(`id`, 'hemant', 'hemant@gmail.com', 'hemant@123', 2147483644, 'XYZ Coloney, PQR Nagar , Jaipur');
...
--
ALTER TABLE `users`
  MODIFY `id` varchar(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
