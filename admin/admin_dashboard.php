...
<body>
    ...
    border-radius: 40px;">
		...
		<div class="container-fluid">
			<div class="navbar-header"><img src="images/achariya_college_of_engineering_TECHNOLOGY-removebg-preview.png" style="max-width: 354px;">
	...
	<div class="row" style="
    margin-left: 37px; flex-direction: column;">
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px;margin-bottom: 30px;">
    ...
    margin-left: 37px;">
		<div class="col-md-3" style="margin: 0px">
			<div class="card bg-light" style="width: 300px; margin-top: -44px;">
