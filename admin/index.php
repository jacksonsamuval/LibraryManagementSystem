...
<body>
	...
	<div class="row" >
		<div class="col-md-4" id="side_bar">
			<img src="images/welcomeACET.png" style="
			max-width: 334px;
			margin-top: 73px;
			margin-left: 150px;
		">
		...
		<div class="col-md-8" id="main_content">
			<center><h3 style="margin-left: -288px;" style="font-family: Verdana, Geneva, Tahoma, sans-serif;">Admin Login</h3></center>
			<form action="" method="post"  style="max-width: 350px; margin-left: 150px;margin-top: 30px;">
				<div class="form-group">
					...
					<input type="text" name="email" placeholder="Enter your E-mail" style="border-radius: 24px;" class="form-control" required>
				</div>
				<div class="form-group">
				...
				<button type="submit" name="login" class="btn btn-primary" style="    border-radius: 20px;
				margin-left: 110px;
				width: 90px;
				margin-top: 17px;
				width: 122px;">Login</button>	
			</form>
			<?php 
